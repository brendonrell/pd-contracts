...
/// @dev Minimal interface used by PDCollection to read the mutable baseTokenURI
///      from PDFactory. MUST be declared outside PDCollection — Solidity does
...
/// @title PDCollection
/// @notice A single generative art collection on Price Discussion.
...
contract PDCollection is ERC721, IERC2981 {
    ...
    ///         factory sweep an already-swept collection without reverting).
    ...
    ///         collection stays immutable while the metadata endpoint can migrate.
    ///         Format: {baseTokenURI}{collectionAddress}/{tokenId}
    ...
    ///         Format: {baseTokenURI}{collectionAddress}
